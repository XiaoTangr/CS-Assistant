    ...
    <div class="container">
        ...
        <div class="inner-container">
            <el-tabs style="height: 100%;" tabPosition="left" v-model="activeName">
                ...
                <el-tab-pane class="panel" label="公告管理" name="notice">
                    <sys-notice-admin />
                </el-tab-pane>
                <el-tab-pane class="panel" label="用户管理" name="user">
                    <sys-user-admin />
                </el-tab-pane>
...
import BizPostAdmin from '@/components/admin/BizPostAdmin.vue';
import SysUserAdmin from '@/components/admin/SysUserAdmin.vue';
