package cn.javat.csa.cms.modules.sys.user.service.impl;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public ServiceResult<SysUserVO> login(String username, String password) {
        ...
        var wrapper = new QueryWrapper<SysUserPO>();
    ...
    public ServiceResult<SysUserVO> register(SysUserRegisterDTO dto) {
        ...
        wrapper.eq("username", dto.getUsername())
                .eq("is_delete", false)
                .eq("is_disable", false);
        SysUserPO isExist = sysUserMapper.selectOne(wrapper);
        if (isExist != null) {
            return ServiceResult.<SysUserVO>builder()
        ...
        SysUserPO newSysUser = SysUserPO.builder()
    ...
    public ServiceResult<SysUserVO> getById(Long currentUserId) {
        SysUserPO sysUser = sysUserMapper.selectById(currentUserId);
        if (sysUser == null) {
            return ServiceResult.<SysUserVO>builder()
                    .code(ServiceResCode.RESOURCE_NOT_FOUND.getCode())
                    .isSuccess(false)
    ...
    public ServiceResult<SysUserVO> update(Long currentUserId, SysUserUpdateDTO params) {
        // 先查询现有数据
        SysUserPO existingUser = sysUserMapper.selectById(currentUserId);
     ...
     * @return 系统用户 VO
     */
    private SysUserVO convertToVO(SysUserPO sysUser) {
