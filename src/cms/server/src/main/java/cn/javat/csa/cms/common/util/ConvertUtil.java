...
public class ConvertUtil {
    ...
    /**
     * 将 BizPostPO 实体转换为 BizPostDTO
     *
     * @param post 业务文章实体
     * @return 业务文章 DTO
     */
    public static BizPostDTO toBizPostDTO(BizPostPO post) {
        if (post == null) {
            return null;
        }
    ...
    /**
     * 将 BizPostPO 实体列表转换为 BizPostDTO 列表
     *
     * @param posts 业务文章实体列表
     * @return 业务文章 DTO 列表
     */
    public static List<BizPostDTO> toBizPostDTOList(List<BizPostPO> posts) {
        if (posts == null) {
            return null;
        }
        return posts.stream()
    ...
    /**
     * 将 BizPostPO 实体转换为 BizPostVO（包含作者简要信息）
     *
     * @param post   业务文章实体
     * @param author 作者用户实体
     * @return 业务文章 VO
     */
    public static BizPostVO toBizPostVO(BizPostPO post, SysUserPO author) {
        if (post == null) {
            return null;
        }
    ...
    /**
     * 将 BizPostPO 实体和 SysUserPO 实体转换为 BizPostDetailVO
     *
     * @param post   业务文章实体
     * @param author 作者用户实体
     * @return 业务文章详情 VO
     */
    public static BizPostDetailVO toBizPostDetailVO(BizPostPO post, SysUserPO author) {
        if (post == null) {
            return null;
        }
    ...
    /**
     * 将 SysUserPO 实体转换为 SysUserVO
     *
     * @param sysUser 系统用户实体
     * @return 系统用户 VO
     */
    public static SysUserVO toSysUserVO(SysUserPO sysUser) {
        if (sysUser == null) {
            return null;
        }
    ...
    /**
     * 将 BizPostDTO 转换为 BizPostPO 实体
     *
     * @param dto 业务文章 DTO
     * @return 业务文章实体
     */
    public static BizPostPO toBizPost(BizPostDTO dto) {
        if (dto == null) {
            return null;
        }
    ...
    /**
     * 将 SysNoticePO 实体转换为 SysNoticeDTO
     *
     * @param notice 系统公告实体
     * @return 系统公告 DTO
     */
    public static SysNoticeDTO toSysNoticeDTO(SysNoticePO notice) {
        if (notice == null) {
            return null;
        }
    ...
    /**
     * 将 SysNoticePO 实体转换为 SysNoticeVO
     *
     * @param notice 系统公告实体
     * @return 系统公告 VO
     */
    public static SysNoticeVO toSysNoticeVO(SysNoticePO notice) {
        if (notice == null) {
            return null;
        }
    ...
    /**
     * 将 SysNoticeDTO 转换为 SysNoticePO 实体
     *
     * @param dto 系统公告 DTO
     * @return 系统公告实体
     */
    public static SysNoticePO toSysNotice(SysNoticeDTO dto) {
        if (dto == null) {
            return null;
        }
