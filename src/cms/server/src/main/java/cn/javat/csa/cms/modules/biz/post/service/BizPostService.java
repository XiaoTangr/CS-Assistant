package cn.javat.csa.cms.modules.biz.post.service;
...
public interface BizPostService {
     ...
     * </p>
     *
     * @param pageQueryDTO 分页参数（包含 page, size, keyword, sort, sortOrder）
     * @param status             文章状态（null=全部，-3=违规，-2=驳回，-1=审核中，0=正常）
     * @param isDraft            是否草稿（null=全部，true=仅草稿，false=非草稿）
     * @return 分页结果
     */
    ServiceResult<Page<BizPostVO>> listAllPosts(PageQueryDTO pageQueryDTO, Integer status, Boolean isDraft);
     ...
     * @return 分页结果
     */
    ServiceResult<Page<BizPostVO>> listMyPosts(Long currentUserId, PageQueryDTO pageQueryDTO, Integer status, Boolean isDraft);
     ...
     * @return 分页结果
     */
    ServiceResult<Page<BizPostVO>> listUserPublicPosts(Long userId, PageQueryDTO pageQueryDTO);
     ...
     * @return 创建的文章
     */
    ServiceResult<BizPostDTO> createPost(BizPostPO post, Long currentUserId);
     ...
     * @return 更新后的文章
     */
    ServiceResult<BizPostDTO> updateMyPost(Long id, BizPostPO post, Long currentUserId);
     ...
     * @return 更新后的文章
     */
    ServiceResult<BizPostDTO> adminUpdatePost(Long id, BizPostPO post, Long currentUserId);
