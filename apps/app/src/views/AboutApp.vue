<template>
    <div class="container">
        <GlassCard shadow="never" body-class="appinfo-body" class="card-item">
            <div class="appinfo">
                <el-image class="appIcon" :src="appIcon" />
                <CommSpace :size="4" direction='vertical' wrap alignment="start">
                    <span class="appName">CS Assistant</span>
                    <span class="appVersion">Ver: alpha 1</span>
                </CommSpace>
            </div>
        </GlassCard>
